...
export default function manifest(): MetadataRoute.Manifest {
  return {
    ...
    shortcuts: [
      {
        name: "Sign Test",
        short_name: "Sign Test",
        description: "Practice computerized traffic sign test",
        url: "/sign-test",
      ...
      },
      {
        name: "Traffic Signs",
        short_name: "Signs",
        description: "Browse Pakistan traffic signs",
        url: "/signs",
        icons: [{ src: "/icons/icon-192.png", sizes: "192x192", type: "image/png" }],
      },
      {
        name: "Rules Practice",
        short_name: "Rules",
        description: "Begin a 20-question rules mock exam",
        url: "/start",
        icons: [{ src: "/icons/icon-192.png", sizes: "192x192", type: "image/png" }],
      },
    ],
